...
var convert = __webpack_require__(105).convert;
var bodyStream = __webpack_require__(127);
...
var fixer = __webpack_require__(154)
normalize.fixer = fixer

var makeWarning = __webpack_require__(168)
...
var scan = __webpack_require__(157)
...
/* MIT license */
var cssKeywords = __webpack_require__(177);
...
var _regenerator = _interopRequireDefault(__webpack_require__(62));

var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(65));

var _promise = _interopRequireDefault(__webpack_require__(34));

var _fs = _interopRequireDefault(__webpack_require__(2));

var _path = _interopRequireDefault(__webpack_require__(20));

var _child_process = __webpack_require__(101);

var _zlib = _interopRequireDefault(__webpack_require__(48));

var _death = _interopRequireDefault(__webpack_require__(102));

var _nodeFetch = _interopRequireDefault(__webpack_require__(103));

var _asyncRetry = _interopRequireDefault(__webpack_require__(130));

var _whichPromise = _interopRequireDefault(__webpack_require__(134));

var _readPkg = _interopRequireDefault(__webpack_require__(141));

var _chmod = _interopRequireDefault(__webpack_require__(170));

var _log = __webpack_require__(171);

/* eslint-disable unicorn/no-process-exit */
// Native
// Packages
// Utilities
_nodeFetch.default.Promise = _promise.default;
global.Promise = _promise.default;
var _process = process,
    platform = _process.platform;
if (detectAlpine()) platform = 'alpine';

var packageDir = _path.default.join(__dirname, '..', '..');

var packageJSON = _readPkg.default.sync(packageDir);

var now = _path.default.join(__dirname, 'now');

var targetWin32 = _path.default.join(__dirname, 'now.exe');

var target = platform === 'win32' ? targetWin32 : now;
var partial = target + '.partial';
var backup = target + '.' + packageJSON.version + '.backup';
var platformToName = {
  alpine: 'now-alpine',
  darwin: 'now-macos',
  linux: 'now-linux',
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (_context2.t0.code === 'EACCES') {
              (0, _log.warn)('Please try installing Now CLI again with the `--unsafe-perm` option.');
              (0, _log.info)('Example: `npm i -g --unsafe-perm now`');
              process.exit();
            }
          ...
          case 8:
            (0, _death.default)(function () {
              _fs.default.writeFileSync(now, '#!/usr/bin/env node\n' + 'console.log("The \'now\' installation did not complete successfully.")\n' + 'console.log("Please run \'npm i -g now\' to reinstall!")\n');

              process.exit();
            });
            (0, _log.info)('For the source code, check out: https://github.com/zeit/now-cli'); // Print an empty line
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _context.prev = 2;
                      name = platformToName[platform];
                      url = "https://github.com/zeit/now-cli/releases/download/".concat(packageJSON.version, "/").concat(name, ".gz");
                      _context.next = 7;
                    ...
                    case 10:
                      ...
                      ws = _fs.default.createWriteStream(partial);
                      _context.next = 14;
                      return new _promise.default(function (resolve, reject) {
                        var bytesRead = 0;
                        resp.body.on('error', reject).on('data', function (chunk) {
                        ...
                        var gunzip = _zlib.default.createGunzip();

                        gunzip.on('error', reject);
                        resp.body.pipe(gunzip).pipe(ws);
                        ws.on('error', reject).on('close', function () {
          ...
          case 13:
            _fs.default.renameSync(partial, target);

            _fs.default.writeFileSync(backup, _fs.default.readFileSync(target));
...
function _main() {
  ...
  _regenerator.default.mark(function _callee3() {
    var globalPath, gitBashFile;
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            if (!_fs.default.existsSync(backup)) {
              _context3.next = 4;
              break;
            }

            _fs.default.writeFileSync(target, _fs.default.readFileSync(backup));
          ...
          case 6:
            ...
            _fs.default.writeFileSync(now, ''); // Workaround for https://github.com/npm/cmd-shim/pull/25


            _context3.t0 = _path.default;
            _context3.next = 12;
            return (0, _whichPromise.default)('npm');

          case 12:
            _context3.t1 = _context3.sent;
            globalPath = _context3.t0.dirname.call(_context3.t0, _context3.t1);
            gitBashFile = _path.default.join(globalPath, 'now');

            if (!_fs.default.existsSync(gitBashFile)) {
              gitBashFile = _path.default.join(process.env.APPDATA, 'npm/now');
            }

            _fs.default.writeFileSync(gitBashFile, modifyGitBashFile(_fs.default.readFileSync(gitBashFile, 'utf8')));
...
module.exports = !__webpack_require__(9) && !__webpack_require__(36)(function () {
...
var parse_url = __webpack_require__(11).parse;
var resolve_url = __webpack_require__(11).resolve;
var http = __webpack_require__(49);
var https = __webpack_require__(104);
...
var Request = __webpack_require__(129);
var FetchError = __webpack_require__(52);
...
var iconvLite = __webpack_require__(106);
...
var bomHandling = __webpack_require__(107),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(108); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(31).concat(__webpack_require__(50)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(51).concat(__webpack_require__(122)) },
...
// Packages
var retrier = __webpack_require__(131);
...
var RetryOperation = __webpack_require__(133);
...
module.exports = __webpack_require__(33)(__webpack_require__(135), __webpack_require__(139));
...
var COLON = isWindows ? ';' : ':'
var isexe = __webpack_require__(136)
...
module.exports = global.Promise || __webpack_require__(140);
...
const loadJsonFile = __webpack_require__(142);
const pathType = __webpack_require__(153);
...
const stripBom = __webpack_require__(147);
const parseJson = __webpack_require__(148);
const pify = __webpack_require__(33);
...
var fs = __webpack_require__(2)
var polyfills = __webpack_require__(144)
...
module.exports = patch(__webpack_require__(53))
...
var errorEx = __webpack_require__(149);
var fallback = __webpack_require__(151);
...
var Uni = __webpack_require__(152)
...
var validateLicense = __webpack_require__(156);
var hostedGitInfo = __webpack_require__(162)
var isBuiltinModule = __webpack_require__(164)
var depTypes = ["dependencies","devDependencies","optionalDependencies"]
var extractDescription = __webpack_require__(166)
var url = __webpack_require__(11)
var typos = __webpack_require__(167)
...
var correct = __webpack_require__(161);
...
*/
var parse = __webpack_require__(56)
var spdxLicenseIds = __webpack_require__(57)
...
var url = __webpack_require__(11)
var gitHosts = __webpack_require__(58)
var GitHost = module.exports = __webpack_require__(163)
...
var builtinModules = __webpack_require__(165);
...
var util = __webpack_require__(13)
var messages = __webpack_require__(169)
...
var _assert = _interopRequireDefault(__webpack_require__(54));

var _chalk = _interopRequireDefault(__webpack_require__(172));

var _progress = _interopRequireDefault(__webpack_require__(183));

// Packages
var bar;

function enableProgress(text) {
  (0, _assert.default)(!bar);
  bar = new _progress.default("> ".concat(text, " [:bar] :percent"), {
...
function warn(text) {
  console.log(_chalk.default.red('> Warning!'), text);
}
...
function disableProgress() {
  (0, _assert.default)(bar); // It is auto-completed once it updates to 100
...
const escapeStringRegexp = __webpack_require__(173);
const ansiStyles = __webpack_require__(174);
const stdoutColor = __webpack_require__(179).stdout;

const template = __webpack_require__(182);
...
const colorConvert = __webpack_require__(176);
...
const os = __webpack_require__(180);
